...
<div class="col-xs-12 col-sm-9">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a type="button" class="btn btn-default btn-educal-danger" data-toggle="modal" data-target="#confirm-delete" href="#" data-href="{{ route('event.delete', $event->id) }}" title="Remove">
